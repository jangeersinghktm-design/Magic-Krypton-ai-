...
const POSTS = [
  ...
  { id:3, tag:"Tips", emoji:"🚀", title:"10 Prompts That Generate Premium Websites", date:"June 1, 2026", readTime:"3 min read",
    ...
    author:"Krypton Team" },
  { id:4, tag:"Feature", emoji:"🤖", title:"Introducing 3-Layer AI Fallback: Claude + OpenAI + Gemini", date:"May 28, 2026", readTime:"5 min read",
    desc:"Krypton AI now routes your requests across Claude, GPT-4o, and Gemini automatically. If one fails, the next kicks in instantly — you never see an error.",
    author:"Krypton Team" },
