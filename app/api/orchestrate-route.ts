        ...
        while (!cachedHtmlResult && (!gate.overallPass || critiqueNeedsRepair) && repairAttempts < MAX_REPAIR_ATTEMPTS) {
          ...
          try {
            ...
            const repairDiff = componentDiffEngine({
              oldContent: componentContent, newContent: repairedComponentContent,
            });
            ...
            const repairedSections = await assembleFromComponentLibrary(_niche, repairedComponentContent, resolvedImages["main"] || [], designSeed + repairAttempts);
