      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
                ...
                <path
                  d="M10 6l-4 3v2l4 3 4-3V9L10 6z"
                  fill="#FFC107"
                  opacity="0.8"
                />
              </svg>
          ...
          {showUserDropdown && (
            ...
            >
              {["Profile", "Billing", "API Keys", "Notifications", "Theme"].map(
                (item) => (
                  <button
                    key={item}
                    style={{
              ...
              >
                ...
                <div style={{ position: "relative" }}>
                  ...
                  {showPlusDropdown && (
                    ...
                    >
                      {["Upload Image", "Upload Screenshot", "Upload File"].map(
                        (item) => (
                          <button
                            key={item}
                            style={{
