    ...
    <div style={{
      ...
      {showSearch && (
        <div onClick={() => setShowSearch(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", zIndex: 200, display: "flex", alignItems: "flex-start", justifyContent: "center", paddingTop: "120px", backdropFilter: "blur(4px)" }}>
          <div onClick={(e) => e.stopPropagation()} style={{ background: "#0D0D0D", border: `1px solid ${T.border}`, borderRadius: "16px", width: "100%", maxWidth: "560px", margin: "0 20px" }}>
      ...
      {/* TOPBAR */}
      <div style={{ padding: "10px 16px", borderBottom: `1px solid ${T.border}`, display: "flex", alignItems: "center", gap: "10px", flexShrink: 0, background: "rgba(8,8,8,0.8)", backdropFilter: "blur(10px)", position: "relative", zIndex: 10 }}>
      ...
      {/* MAIN CONTENT */}
      <div style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "1.5rem 1rem", position: "relative", zIndex: 1 }}>
        <div style={{ width: "100%", maxWidth: "700px" }}>
          ...
          <div style={{ marginBottom: "2rem", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", gap: "10px", justifyContent: "center", marginTop: "16px", flexWrap: "wrap" }}>
              {[
                ...
                <div key={stat.label} style={{ padding: "5px 14px", background: "#0D0D0D", border: `1px solid ${T.border}`, borderRadius: "20px", fontSize: "12px", color: T.muted }}>
          ...
          {/* Prompt Input */}
          <div style={{ background: "#0D0D0D", border: `1px solid ${T.border}`, borderRadius: "16px", padding: "16px", boxShadow: "0 0 40px rgba(245,197,66,0.06)" }}>
            <textarea
              value={prompt}
              ...
              style={{ width: "100%", background: "none", border: "none", color: T.text, fontSize: "15px", resize: "none", outline: "none", fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6, boxSizing: "border-box" }}
            />
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "8px", paddingTop: "10px", borderTop: `1px solid ${T.border}` }}>
              {/* Build type dropdown */}
              <div style={{ position: "relative" }}>
                <button onClick={() => setShowBuildDropdown(!showBuildDropdown)} style={{ padding: "6px 12px", background: "#1a1a1a", border: `1px solid ${T.border}`, borderRadius: "8px", color: T.text, fontSize: "12px", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}>
                  {buildType} ▾
                </button>
                {showBuildDropdown && (
                  <div style={{ position: "absolute", bottom: "40px", left: 0, background: "#0D0D0D", border: `1px solid ${T.border}`, borderRadius: "10px", padding: "6px", zIndex: 50, minWidth: "130px" }}>
                    {["Website", "App", "Game", "Tool", "Dashboard"].map((type) => (
                      <button key={type} onClick={() => { setBuildType(type); setShowBuildDropdown(false); }}
                        style={{ width: "100%", textAlign: "left", padding: "8px 12px", background: "none", border: "none", color: T.muted, fontSize: "13px", cursor: "pointer", borderRadius: "7px" }}
              ...
              <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                <button onClick={handleVoice} style={{ width: "34px", height: "34px", borderRadius: "50%", background: listening ? T.gold : "#2a2a2a", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <button onClick={handleGenerate} disabled={!prompt.trim()} style={{ width: "40px", height: "40px", borderRadius: "50%", background: prompt.trim() ? "linear-gradient(135deg,#F5C542,#00D084)" : "#1a1a1a", border: "none", cursor: prompt.trim() ? "pointer" : "not-allowed", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: prompt.trim() ? "0 0 12px rgba(245,197,66,0.4)" : "none" }}>
